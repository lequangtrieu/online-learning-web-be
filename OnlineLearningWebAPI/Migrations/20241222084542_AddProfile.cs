    ...
    public partial class AddProfile : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVIP = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: "1",
                columns: new[] { "ConcurrencyStamp", "SecurityStamp" },
                values: new object[] { "a669678f-c4cd-428b-a92b-25f7868d8eda", "5390917a-284b-4f55-ab7c-524ef0e5b61e" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: "2",
                columns: new[] { "ConcurrencyStamp", "SecurityStamp" },
                values: new object[] { "5a94ba4b-e3e6-4b28-b7d0-72d7dcaea3d8", "b306ed52-bbb1-41e1-bf02-50651cf35dc3" });
        }
    }
}
